            ...
            <div className="w-full lg:w-1/2">
                <div className="flex justify-between">
                    <div className="lg:hidden">
                         <a href="#" className="flex justify-center items-center w-10 h-10 rounded-xl bg-gray-50">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <div className="lg:relative">
                            <button onClick={()=>setIsOpen(!isOpen)}  className="h-10 w-10 rounded-full overflow-hidden focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-800 focus:ring-offset-white">
                                <img  src="https://picsum.photos/200" alt="" className="w-10 h-10 object-cover" />
                            </button>

                            <button onClick={()=>setIsOpen(!isOpen)} className={`${isOpen ? 'fixed':'hidden'} inset-0 w-full h-full z-30 cursor-default`} tabIndex="-1"></button>
                            ...
                            <div  className={`${isOpen ? 'block':'hidden'} absolute right-0 z-40 mt-2  w-full lg:w-48  `}>
                                <div className="bg-white mx-4 lg:mx-0 rounded-md shadow-lg py-1 ring-1 ring-black ring-opacity-5">
                                    ...
                                    <div className="lg:hidden border-b">
                                        <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-green-100">Feedback</a>
                                        <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-green-100">Contact</a>
                                        <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-green-100">Help</a>
                                    </div>
